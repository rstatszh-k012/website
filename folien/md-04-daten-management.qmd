...
homework_due_date <- vars$`md-04`$`homework-due` |> as.Date()
...
::: {.column width="50%"}
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("img/md-04/readxl.png")
```
:::
:::::
...
::: learn-more
[{{< var course.site-short >}}module/md-04.html]({{< var course.site >}}module/md-04.html)
:::
...
Folien als [PDF auf GitHub]({{< var course.github-org >}}website/raw/main/folien/md-04-daten-management.pdf)
